  ...
  return (
    <div className="font-[inter] px-[100px] mt-[90px]">
      ...
      <div className="mt-[70px] flex">
        ...
        <div className="border border-[#8F8F8F] w-[412px] h-[382px] rounded-[20px] bg-[#FFFFFF] mr-[24px]">
        ...
        <div className="border border-[#8F8F8F] w-[412px] h-[382px] rounded-[20px] bg-[#FFFFFF]">
          <div className="flex justify-center mt-[25px]">
            <div className="w-[80px] h-[80px] bg-[#8F8F8F] rounded-full"></div>
          </div>
          <h1 className="text-[30px] font-[500] mt-[20px] text-center ">
